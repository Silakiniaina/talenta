...
<%@ page import="model.TypeConge" %> 

<%
    List<Employe> employes = (List<Employe>)request.getAttribute("employes");
    List<TypeConge> types = (List<TypeConge>)request.getAttribute("types");
%>
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Ajout Conge</h4>
                                        <form class="forms-sample" action="addConge" method="post">
                                                ...
                                                <select class="form-control" id="type" name="type">
                                                    <%
                                                        for (TypeConge type : types) {
                                                            out.println("<option value=\"" + type.getIdTypeConge() + "\">" + type.getNomType()+ "</option>");
                                                        }
                                                    %>
                                                </select>
                                            </div>
