                                            ...
                                            <tbody>
                                                ...
                                                %>
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <a type="button" class="btn btn-sm btn-outline-primary" href="attribuerTest?idCandidat=<%= candidat.getIdCandidat() %>&recrutement=<%= recrutement.getIdRecrutement() %>">Tester</a>
