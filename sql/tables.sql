...
CREATE  TABLE reponse_test_possibles ( 
...
CREATE  TABLE reponse_attendue ( 
	...
	CONSTRAINT reponse_attendue_id_reponse_attendue_fkey FOREIGN KEY ( id_reponse_attendue ) REFERENCES reponse_test_possibles( id_reponse_test_possibles )   ,
	CONSTRAINT reponse_attendue_id_question_simulation_fkey FOREIGN KEY ( id_question_test ) REFERENCES question_test( id_question_test )   ,
	CONSTRAINT reponse_attendue_id_simulation_fkey FOREIGN KEY ( id_test ) REFERENCES test( id_test )   
 );
